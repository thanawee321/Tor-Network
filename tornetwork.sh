...
# All Source from https://github.com/brainfucksec/kalitorify/tree/master
#                                                                              #
################################################################################
...
#
# program information
readonly prog_name="tornetwork"
readonly version="2.0.0"
readonly signature="Copyright (C) 2025 BabyH@ck"
readonly git_url="https://github.com/thanawee321/Tor-Network"
...
## Directories
readonly data_dir="/usr/share/tornetwork/data"      # config files
readonly backup_dir="/var/lib/tornetwork/backups"   # backups
...
printf "${b}${white}
        ...
        ██████╔╝  ██║  ██║  ██████╔╝    ██║    ██║  ██║ ██║ ████║ ██║   ██╗ ██╔══██╗
        ╚═════╝   ╚═╝  ╚═╝  ╚═════╝     ╚═╝    ╚═╝  ╚═╝  ╚══╝╚══╝ ╚██████╔╝ ╚═╝  ╚═╝
                                                             (TOR_NETWORK_v${VERSION})

=[ Transparent proxy through Tor
=[ BabyH@CK SayhEllojubJU$
${reset}\\n\\n"
}
...
usage() {
    ...
    printf "%s\\n" "-q, --quite  reset iptables and return to clearnet navigation"
